...
sequence=array(sequences[1],dtype=float)    
...
iDCTx=myidct4(piecew([0,0,0,1]),N)#  start with a basis fn of DCT
...
#myplot(t,imag(iDFTx(t)),[min(1,c+.5) for c in dftcolor]) #imaginary line
...
myscalemin=min(abs(DFTx(nextended)))
